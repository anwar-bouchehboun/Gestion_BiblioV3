...
menuRecherche();
    ...
    public void MenuStartJournal(){
        ...
        System.out.println("|Appuyez sur 1 pour" +CostumColor.PURPLE_BOLD_BRIGHT +"|• GESTION (JournalScientifique)"      + CostumColor.RESET);
        System.out.println("|Appuyez sur 2 pour" +CostumColor.PURPLE_BOLD_BRIGHT +"|• GESTION (ThèseUniversitaire)"      + CostumColor.RESET);
        System.out.println("|Appuyez sur 3 pour" +CostumColor.PURPLE_BOLD_BRIGHT +"|• Rechercher un document(JournalScientifique ou ThèseUniversitaire) "+ CostumColor.RESET);
    ...
    public void menuMiseAjourJournal(){
        do {
            System.out.println(CostumColor.BROWN_BACKGROUND+CostumColor.WHITE_BOLD_BRIGHT+"----------------------------------------------------------- "+ CostumColor.RESET);
            System.out.println(CostumColor.BLUE_BOLD_BRIGHT+"|Choisissez l'option ci-dessous en fonction de votre Désignation  : " + CostumColor.RESET);
            System.out.println("|Appuyez sur 1 pour" +CostumColor.PURPLE_BOLD_BRIGHT +"|• Ajouter un document (JournalScientifique )"      + CostumColor.RESET);
            System.out.println("|Appuyez sur 2 pour" +CostumColor.PURPLE_BOLD_BRIGHT +"|• Modifier un document "  + CostumColor.RESET);
            System.out.println("|Appuyez sur 3 pour" +CostumColor.PURPLE_BOLD_BRIGHT +"|• Supprimer un document   (JournalScientifique )"+ CostumColor.RESET);
            System.out.println("|Appuyez sur 4 pour" +CostumColor.PURPLE_BOLD_BRIGHT +"|• Affiche un document   (JournalScientifique)"+ CostumColor.RESET);
            System.out.println("|Appuyez sur 5 pour" +CostumColor.PURPLE_BOLD_BRIGHT +"| _____EXIT JournalT__________"+ CostumColor.RESET);
            System.out.println(CostumColor.BROWN_BACKGROUND+CostumColor.WHITE_BOLD_BRIGHT+"----------------------------------------------------------- "+ CostumColor.RESET);
            System.out.println("Choix => : " +CostumColor.PURPLE_BOLD_BRIGHT + " CHOIX "+ CostumColor.RESET);
    ...
    public void menuMiseAjourThese(){
        do {
            System.out.println(CostumColor.BROWN_BACKGROUND+CostumColor.WHITE_BOLD_BRIGHT+"----------------------------------------------------------- "+ CostumColor.RESET);
            System.out.println(CostumColor.BLUE_BOLD_BRIGHT+"|Choisissez l'option ci-dessous en fonction de votre Désignation : " + CostumColor.RESET);
            System.out.println("|Appuyez sur 1 pour" +CostumColor.PURPLE_BOLD_BRIGHT +"|• Ajouter un document (ThèseUniversitaire )"      + CostumColor.RESET);
            System.out.println("|Appuyez sur 2 pour" +CostumColor.PURPLE_BOLD_BRIGHT +"|• Modifier un document "  + CostumColor.RESET);
            System.out.println("|Appuyez sur 3 pour" +CostumColor.PURPLE_BOLD_BRIGHT +"|• Supprimer un document   (ThèseUniversitaire )"+ CostumColor.RESET);
            System.out.println("|Appuyez sur 4 pour" +CostumColor.PURPLE_BOLD_BRIGHT +"|• Affiche un document   (ThèseUniversitaire)"+ CostumColor.RESET);
            System.out.println("|Appuyez sur 5 pour" +CostumColor.PURPLE_BOLD_BRIGHT +"| _____EXIT ThèseUniversitaire__________"+ CostumColor.RESET);
            System.out.println(CostumColor.BROWN_BACKGROUND+CostumColor.WHITE_BOLD_BRIGHT+"----------------------------------------------------------- "+ CostumColor.RESET);
            System.out.println("Choix => : " +CostumColor.PURPLE_BOLD_BRIGHT + " CHOIX "+ CostumColor.RESET);
